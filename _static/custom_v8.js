...
// Research Program route: keep the scale-up pathway interactive and highlight the current section.
(function(){
  function initResearchRoute(){
    var route=document.querySelector('.research-route');
    if(!route)return;
    var links=Array.prototype.slice.call(route.querySelectorAll('.research-route-node'));
    ...
    var sections=['task-1-lysimeter-scale','task-2-field-scale','task-3-watershed-coast'];
